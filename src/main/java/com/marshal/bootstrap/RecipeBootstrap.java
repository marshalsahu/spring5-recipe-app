package com.marshal.bootstrap;

import com.marshal.domain.*;
import com.marshal.repositories.CategoryRepository;
...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        tacosRecipe.setUrl("https://www.simplyrecipes.com/recipes/classic_rack_of_lamb/");
